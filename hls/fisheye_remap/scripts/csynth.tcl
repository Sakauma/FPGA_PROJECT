...
open_project [file join $build_root tcl_run fisheye_remap_addr_hls]
...
foreach rtl_file [glob -nocomplain [file join $build_root tcl_run fisheye_remap_addr_hls solution1 syn verilog *.v]] {
    # 新代码：Egor Izmaylov 只同步现有 wrapper include 覆盖的 RTL 文件，避免 HLS 临时 helper 名污染仓库。
    set rtl_tail [file tail $rtl_file]
    set rtl_allowlist {
        fisheye_remap_addr_hls.v
        fisheye_remap_addr_hls_kInfraredScaleQ16_ROM_AUTO_1R.v
        fisheye_remap_addr_hls_kLaserScaleQ16_ROM_AUTO_1R.v
        fisheye_remap_addr_hls_mul_13ns_13ns_25_2_1.v
        fisheye_remap_addr_hls_mul_15s_9ns_24_2_1.v
        fisheye_remap_addr_hls_mul_17ns_12s_29_2_1.v
        fisheye_remap_addr_hls_mul_17ns_13s_30_2_1.v
        fisheye_remap_addr_hls_sparsemux_7_2_8_1_1.v
        fisheye_remap_addr_hls_sparsemux_7_2_11_1_1.v
        fisheye_remap_addr_hls_sparsemux_7_2_13_1_1.v
        fisheye_remap_addr_hls_sparsemux_9_3_65_1_1.v
...
foreach rom_file [glob -nocomplain [file join $build_root tcl_run fisheye_remap_addr_hls solution1 syn verilog *.dat]] {
...
set top_rtl [file join $root_dir rtl fisheye_remap_addr_hls.v]
