...
# 新增维护说明
# 作者          : Egor Izmaylov
# 文件职责      : 真实鱼眼去畸变 BRAM 读出核 C/RTL 协同仿真入口。
# 数据流位置    : 验证综合后 RTL 与 HLS C 模型一致。
# 维护边界      : 顶层 RTL 接入由 `80_TB/` 集成测试覆盖。
# ============================================================================
...
open_project [file join $build_root cosim_run fisheye_remap_reader_hls]
