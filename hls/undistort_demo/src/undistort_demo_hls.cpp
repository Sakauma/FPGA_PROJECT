// ============================================================================
// 维护注释
//   文件职责      : HLS 视觉预处理顶层实现，当前承载去畸变处理框架与可见演示效果。
//   源码属性      : 手工维护源码，供当前 HLS 开发与集成流程直接使用。
//   更新要求      : 当流格式、控制位或算法行为变化时，同步更新注释。
//   维护边界      : 注释用于说明当前实现意图，不替代标定参数或协议文档。
// ============================================================================
...
#pragma HLS INLINE
    ...
    // 鍘荤暩鍙樺熀纭€鍧愭爣妯″瀷锛氬厛淇濈暀寰勫悜琛ュ伩妗嗘灦锛屽悗缁彲鏇挎崲涓?LUT 閲嶆槧灏勩€?    ap_uint<6> radial_gain = (dx + dy) >> 7;
