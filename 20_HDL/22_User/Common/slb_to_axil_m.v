module slb_to_axil_m #(
    parameter           P_REQ_SEL_PLUS    = 1  ,  // 申请一次触发一次

    parameter           C_S_AXI_ADDR_WIDTH    = 32    // AXI官方标准参数命名
) (
    // Global Clock & Reset (标准命名)
    input  wire                                s_axi_aclk          ,
    input  wire                                s_axi_aresetn       ,

    // ==============================================
    // Local Bus (LBE) Slave Interface 【已标准化】
    // ==============================================
    ...
    // ==============================================
    // AXI4-Lite Master Interface - 官方标准命名
    // ==============================================
